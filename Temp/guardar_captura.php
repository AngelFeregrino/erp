...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // 3. Actualizar cantidad_total_lote en ordenes_produccion
    // Obtener orden_id y pieza_id de la captura
    ...
    // Sumar todas las cantidades de las capturas cerradas de esa orden y pieza
    ...
    echo json_encode(['success' => true, 'mensaje' => '✅ Captura registrada correctamente.', 'total_capturado' => $total_capturado]);
    exit();
}
?>
